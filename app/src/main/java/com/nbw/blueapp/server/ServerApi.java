...
public class ServerApi {
    ...
    static private Call getParam(String url,
        ...
        builder.addQueryParameter("page", page)
                ...
                .addQueryParameter("subLocal", subLocal)
    ...
    //공지사항 가져오기
    static public void getNotice(final PostCallBack cb) {
        get(SERVER_IP+"/blue/v1/boards/notice", new Callback() {
            @Override
            public void onFailure(Call call, IOException e) {
                if (cb != null)
                    cb.onResponse(null, e.getMessage());
    ...
    static public void getSites(String page,
        ...
        getParam(SERVER_IP+"/blue/v1/sites/", page, size, targetMain, targetDetail, local, subLocal, all_local, income, all_income, age, all_age, gender, all_gender, siteName, new Callback() {
            @Override
            public void onFailure(Call call, IOException e) {
                if (cb != null)
                    cb.onResponse(null, e.getMessage());
